...
@section('content')
    ...
    <header class="mb-4">
        ...
        <p class="text-muted mb-0">Open a campaign view or review pending canon updates.</p>
    </header>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="{{ route('app.campaign.approvals') }}" class="card shadow-sm h-100 text-decoration-none home-quick-card">
                <div class="card-body p-4">
                    <div class="home-quick-icon mb-3">
                        <i class="ph ph-check-square"></i>
                    </div>
                    <h2 class="h6 fw-semibold mb-1">Approvals</h2>
                    <p class="text-muted small mb-0">Commit or reject proposed canon changes.</p>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-lg-3">
