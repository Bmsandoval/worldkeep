...
4. Open PR to `develop` with `- Resolves Bmsandoval/worldkeep#<N>` as the **first line**
...
```text
- Resolves Bmsandoval/worldkeep#<sub-issue-number>
```
...
```markdown
- Resolves Bmsandoval/worldkeep#<sub>
...
- [ ] Tests run green
- [ ] First line: `- Resolves Bmsandoval/worldkeep#<N>`
